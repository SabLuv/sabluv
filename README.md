<div align="center">
  ...
  <h1>Привет, я Дуринда(Durinji = Дуринжи) 👋</h1>

  <p>
    Я обычный чел, который реализует свои идеи в реальность.<br>
    Занимался разработкой многостраничных сайтов на <strong>Vue</strong> и разработал пару крупных Telegram-ботов.<br>
    Если меня что-то зацепило — не брошу, пока не заебу себе мозги и не выведу в релиз.
  </p>

  <p>
    Сейчас в основном сижу на <strong>Python</strong>,<br>
    в будущем хочу перейти на <strong>C++</strong> или <strong>C#</strong>.<br>
    Раньше писал консольные программы на C#, но в итоге забросил.
  </p>
